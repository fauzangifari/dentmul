...
import { KATEGORI_OPTIONS, STATUS_OPTIONS } from "@/features/koas/constants";
  ...
  return (
    <div className="flex flex-col gap-3 rounded-2xl border border-border bg-card p-3 shadow-sm sm:flex-row sm:items-center">
      ...
      <div className="flex gap-3">
        <Select
          value={kategori}
          onValueChange={(v) => pushParams({ kategori: v })}
        >
          <SelectTrigger className="h-11 flex-1 sm:w-44 sm:flex-none" aria-label="Filter kategori">
